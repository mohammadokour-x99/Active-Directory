...
</rich_text><rich_text foreground="#2ec27e">from the responder results we can conclude that victem user didn't connect to us throuh IconFile instead connect through URL after visiting it </rich_text><rich_text>
