...
1) Get-GPPPassword (finds cpassword and decrypt it)  (on windows)
...
after this use credentials for laterally or escalate privileges like doing kerberoasting attack,gaining shell access (psexec,psexec.py,smbexec,wmiexec), ..etc
